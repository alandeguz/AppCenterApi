...
extension EngagementAPI.Billing {
    ...
    */
    public enum BillingAggregatedInformationGetAll {

        public static let service = APIService<Response>(id: "billingAggregatedInformation_getAll", tag: "billing", method: "GET", path: "/v0.1/billing/allAccountsAggregated", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(service: ServiceTypeFilterParameter? = nil, period: PeriodTypeFilterParameter? = nil, showOriginalPlans: Bool? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: BillingAggregatedInformationGetAll.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(service: ServiceTypeFilterParameter? = nil, period: PeriodTypeFilterParameter? = nil, showOriginalPlans: Bool? = nil) {
                let options = Options(service: service, period: period, showOriginalPlans: showOriginalPlans)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                /** Aggregated Billing Information for the requesting user and the organizations in which the user is an admin. */
                public class AggregatedBillings: APIModel {
                    ...
                    public func isEqual(to object: Any?) -> Bool {
                      guard let object = object as? AggregatedBillings else { return false }
                    ...
                    public static func == (lhs: AggregatedBillings, rhs: AggregatedBillings) -> Bool {
                        return lhs.isEqual(to: rhs)
                    }
                }
                ...
                private enum CodingKeys: String, CodingKey {
                    case aggregatedBillings
                }

                public required init(from decoder: Decoder) throws {
                    let container = try decoder.container(keyedBy: CodingKeys.self)

                    aggregatedBillings = try container.decodeIfPresent(.aggregatedBillings)
                }

                public func encode(to encoder: Encoder) throws {
                    var container = encoder.container(keyedBy: CodingKeys.self)

                    try container.encodeIfPresent(aggregatedBillings, forKey: .aggregatedBillings)
                }

                public func isEqual(to object: Any?) -> Bool {
                  guard let object = object as? Status200 else { return false }
                  guard self.aggregatedBillings == object.aggregatedBillings else { return false }
                  return true
                }
