...
extension EngagementAPI.Billing {
    ...
    */
    public enum BillingAggregatedInformationGetByApp {

        public static let service = APIService<Response>(id: "billingAggregatedInformation_getByApp", tag: "billing", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/billing/aggregated", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(service: ServiceTypeFilterParameter? = nil, period: PeriodTypeFilterParameter? = nil, showOriginalPlans: Bool? = nil, ownerName: String, appName: String) {
            ...
            public init(options: Options) {
                ...
                super.init(service: BillingAggregatedInformationGetByApp.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(service: ServiceTypeFilterParameter? = nil, period: PeriodTypeFilterParameter? = nil, showOriginalPlans: Bool? = nil, ownerName: String, appName: String) {
                let options = Options(service: service, period: period, showOriginalPlans: showOriginalPlans, ownerName: ownerName, appName: appName)
