...
extension EngagementAPI.Distribute {
    ...
    */
    public enum StoresDelete {

        public static let service = APIService<Response>(id: "stores_delete", tag: "distribute", method: "DELETE", path: "/v0.1/apps/{owner_name}/{app_name}/distribution_stores/{store_name}", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: String?, options: Options) {
                ...
                super.init(service: StoresDelete.service) {
            ...
            public convenience init(storeName: String, body: String? = nil, ownerName: String, appName: String) {
