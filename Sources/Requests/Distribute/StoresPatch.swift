...
extension EngagementAPI.Distribute {
    ...
    Update the store.
    */
    public enum StoresPatch {

        public static let service = APIService<Response>(id: "stores_patch", tag: "distribute", method: "PATCH", path: "/v0.1/apps/{owner_name}/{app_name}/distribution_stores/{store_name}", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: Body, options: Options) {
                ...
                super.init(service: StoresPatch.service) {
            ...
            public convenience init(storeName: String, body: Body, ownerName: String, appName: String) {
