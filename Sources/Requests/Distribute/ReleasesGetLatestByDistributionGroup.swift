...
extension EngagementAPI.Distribute {
    ...
    */
    public enum ReleasesGetLatestByDistributionGroup {

        public static let service = APIService<Response>(id: "releases_getLatestByDistributionGroup", tag: "distribute", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/distribution_groups/{distribution_group_name}/releases/{release_id}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(ownerName: String, appName: String, distributionGroupName: String, releaseId: String) {
            ...
            public init(options: Options) {
                ...
                super.init(service: ReleasesGetLatestByDistributionGroup.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(ownerName: String, appName: String, distributionGroupName: String, releaseId: String) {
