...
extension EngagementAPI.Distribute {
    ...
    */
    public enum StoreReleasePublishLogsGet {

        public static let service = APIService<Response>(id: "storeReleasePublishLogs_get", tag: "distribute", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/distribution_stores/{store_name}/releases/{release_id}/publish_logs", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: StoreReleasePublishLogsGet.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(storeName: String, releaseId: String, ownerName: String, appName: String) {
