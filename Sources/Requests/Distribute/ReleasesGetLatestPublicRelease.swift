...
extension EngagementAPI.Distribute {
    ...
    */
    public enum ReleasesGetLatestPublicRelease {

        public static let service = APIService<Response>(id: "releases_getLatestPublicRelease", tag: "distribute", method: "GET", path: "/v0.1/public/sdk/apps/{app_secret}/releases/latest", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ReleasesGetLatestPublicRelease.service)
            }
