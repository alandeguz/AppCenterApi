...
extension EngagementAPI.Distribute {
    ...
    */
    public enum AppleMappingTestFlightGroups {

        public static let service = APIService<Response>(id: "appleMapping_TestFlightGroups", tag: "distribute", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/apple_test_flight_groups", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppleMappingTestFlightGroups.service)
            }
