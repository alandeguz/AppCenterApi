...
extension EngagementAPI.Distribute {
    ...
    */
    public enum ReleasesGetLatestByUser {

        public static let service = APIService<Response>(id: "releases_getLatestByUser", tag: "distribute", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/releases/{release_id}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(releaseId: String, udid: String? = nil, ownerName: String, appName: String) {
            ...
            public init(options: Options) {
                ...
                super.init(service: ReleasesGetLatestByUser.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(releaseId: String, udid: String? = nil, ownerName: String, appName: String) {
                let options = Options(releaseId: releaseId, udid: udid, ownerName: ownerName, appName: appName)
