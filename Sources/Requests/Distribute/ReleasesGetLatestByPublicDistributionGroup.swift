...
extension EngagementAPI.Distribute {
    ...
    */
    public enum ReleasesGetLatestByPublicDistributionGroup {

        public static let service = APIService<Response>(id: "releases_getLatestByPublicDistributionGroup", tag: "distribute", method: "GET", path: "/v0.1/public/sdk/apps/{app_secret}/distribution_groups/{distribution_group_id}/releases/latest", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(appSecret: String, distributionGroupId: String) {
            ...
            public init(options: Options) {
                ...
                super.init(service: ReleasesGetLatestByPublicDistributionGroup.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(appSecret: String, distributionGroupId: String) {
                let options = Options(appSecret: appSecret, distributionGroupId: distributionGroupId)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "appSecret" + "}", with: "\(self.options.appSecret)").replacingOccurrences(of: "{" + "distributionGroupId" + "}", with: "\(self.options.distributionGroupId)")
            }
        }
