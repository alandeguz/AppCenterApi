...
extension EngagementAPI.Distribute {
    ...
    */
    public enum StoreNotificationsGetNotificationByAppId {

        public static let service = APIService<Response>(id: "storeNotifications_getNotificationByAppId", tag: "distribute", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/store_service_status", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: StoreNotificationsGetNotificationByAppId.service)
            }
