...
extension EngagementAPI.Distribute {
    ...
    */
    public enum StoresList {

        public static let service = APIService<Response>(id: "stores_list", tag: "distribute", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/distribution_stores", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: StoresList.service)
            }
