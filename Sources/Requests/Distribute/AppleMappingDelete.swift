...
extension EngagementAPI.Distribute {
    ...
    */
    public enum AppleMappingDelete {

        public static let service = APIService<Response>(id: "appleMapping_delete", tag: "distribute", method: "DELETE", path: "/v0.1/apps/{owner_name}/{app_name}/apple_mapping", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: String?, options: Options) {
                ...
                super.init(service: AppleMappingDelete.service) {
            ...
            public convenience init(body: String? = nil, ownerName: String, appName: String) {
