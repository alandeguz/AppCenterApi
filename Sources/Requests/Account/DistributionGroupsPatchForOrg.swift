...
extension EngagementAPI.Account {
    ...
    */
    public enum DistributionGroupsPatchForOrg {

        public static let service = APIService<Response>(id: "distributionGroups_patchForOrg", tag: "account", method: "PATCH", path: "/v0.1/orgs/{org_name}/distribution_groups/{distribution_group_name}", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(distributionGroup: DistributionGroup, options: Options) {
                ...
                super.init(service: DistributionGroupsPatchForOrg.service) {
            ...
            public convenience init(orgName: String, distributionGroupName: String, distributionGroup: DistributionGroup) {
