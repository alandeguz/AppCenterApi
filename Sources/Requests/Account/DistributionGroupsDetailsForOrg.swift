...
extension EngagementAPI.Account {
    ...
    */
    public enum DistributionGroupsDetailsForOrg {

        public static let service = APIService<Response>(id: "distributionGroups_detailsForOrg", tag: "account", method: "GET", path: "/v0.1/orgs/{org_name}/distribution_groups_details", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public var appsLimit: Double?

                public init(orgName: String, appsLimit: Double? = nil) {
                    self.orgName = orgName
                    self.appsLimit = appsLimit
                }
            }
            ...
            public init(options: Options) {
                ...
                super.init(service: DistributionGroupsDetailsForOrg.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(orgName: String, appsLimit: Double? = nil) {
                let options = Options(orgName: orgName, appsLimit: appsLimit)
            ...
            public override var parameters: [String: Any] {
                ...
                if let appsLimit = options.appsLimit {
                  params["apps_limit"] = appsLimit
                }
                return params
            }
        }
