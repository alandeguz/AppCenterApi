...
extension EngagementAPI.Account {
    ...
    */
    public enum TeamsListAll {

        public static let service = APIService<Response>(id: "teams_listAll", tag: "account", method: "GET", path: "/v0.1/orgs/{org_name}/teams", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: TeamsListAll.service)
            }
