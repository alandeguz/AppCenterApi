...
extension EngagementAPI.Account {
    ...
    */
    public enum OrganizationsUpdate {

        public static let service = APIService<Response>(id: "organizations_update", tag: "account", method: "PATCH", path: "/v0.1/orgs/{org_name}", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))

        public final class Request: APIRequest<Response> {

            /** Returns a list of organizations the requesting user has access to */
            public class Org: APIModel {
                ...
                public func isEqual(to object: Any?) -> Bool {
                  guard let object = object as? Org else { return false }
            ...
            public init(org: Org, options: Options) {
                self.org = org
                self.options = options
                super.init(service: OrganizationsUpdate.service) {
                    let jsonEncoder = JSONEncoder()
                    return try jsonEncoder.encode(org)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(orgName: String, org: Org) {
                let options = Options(orgName: orgName)
                self.init(org: org, options: options)
            }
