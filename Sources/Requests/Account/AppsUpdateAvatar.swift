...
extension EngagementAPI.Account {
    ...
    Sets the app avatar
    */
    public enum AppsUpdateAvatar {

        public static let service = APIService<Response>(id: "apps_updateAvatar", tag: "account", method: "POST", path: "/v0.1/apps/{owner_name}/{app_name}/avatar", hasBody: true, hasFile: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(ownerName: String, appName: String, avatar: File? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppsUpdateAvatar.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(ownerName: String, appName: String, avatar: File? = nil) {
                let options = Options(ownerName: ownerName, appName: appName, avatar: avatar)
            ...
            public override var parameters: [String: Any] {
                ...
                if let avatar = options.avatar?.encode() {
