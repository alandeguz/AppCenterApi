...
extension EngagementAPI.Account {
    ...
    */
    public enum DistributionGroupsList {

        public static let service = APIService<Response>(id: "distributionGroups_list", tag: "account", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/distribution_groups", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DistributionGroupsList.service)
            }
