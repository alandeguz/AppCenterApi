...
extension EngagementAPI.Account {
    ...
    */
    public enum OrganizationUpdateAvatar {

        public static let service = APIService<Response>(id: "organization_updateAvatar", tag: "account", method: "POST", path: "/v0.1/orgs/{org_name}/avatar", hasBody: true, hasFile: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(orgName: String, avatar: File? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: OrganizationUpdateAvatar.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(orgName: String, avatar: File? = nil) {
                let options = Options(orgName: orgName, avatar: avatar)
