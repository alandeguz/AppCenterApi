...
extension EngagementAPI.Account {
    ...
    */
    public enum TeamsUpdate {

        public static let service = APIService<Response>(id: "teams_update", tag: "account", method: "PATCH", path: "/v0.1/orgs/{org_name}/teams/{team_name}", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(team: Team?, options: Options) {
                ...
                super.init(service: TeamsUpdate.service) {
            ...
            public convenience init(orgName: String, teamName: String, team: Team? = nil) {
