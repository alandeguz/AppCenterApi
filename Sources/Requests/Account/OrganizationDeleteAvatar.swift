...
extension EngagementAPI.Account {
    ...
    */
    public enum OrganizationDeleteAvatar {

        public static let service = APIService<Response>(id: "organization_deleteAvatar", tag: "account", method: "DELETE", path: "/v0.1/orgs/{org_name}/avatar", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: OrganizationDeleteAvatar.service)
            }
