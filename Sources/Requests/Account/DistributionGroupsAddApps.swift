...
extension EngagementAPI.Account {
    ...
    */
    public enum DistributionGroupsAddApps {

        public static let service = APIService<Response>(id: "distributionGroups_addApps", tag: "account", method: "POST", path: "/v0.1/orgs/{org_name}/distribution_groups/{distribution_group_name}/apps", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(apps: Apps, options: Options) {
                ...
                super.init(service: DistributionGroupsAddApps.service) {
