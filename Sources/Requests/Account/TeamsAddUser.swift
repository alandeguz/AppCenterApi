...
extension EngagementAPI.Account {
    ...
    */
    public enum TeamsAddUser {

        public static let service = APIService<Response>(id: "teams_addUser", tag: "account", method: "POST", path: "/v0.1/orgs/{org_name}/teams/{team_name}/users", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(userEmail: UserEmail?, options: Options) {
                ...
                super.init(service: TeamsAddUser.service) {
            ...
            public convenience init(orgName: String, teamName: String, userEmail: UserEmail? = nil) {
