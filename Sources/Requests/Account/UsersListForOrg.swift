...
extension EngagementAPI.Account {
    ...
    */
    public enum UsersListForOrg {

        public static let service = APIService<Response>(id: "users_listForOrg", tag: "account", method: "GET", path: "/v0.1/orgs/{org_name}/users", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UsersListForOrg.service)
            }
