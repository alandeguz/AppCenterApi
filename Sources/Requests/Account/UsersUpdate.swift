...
extension EngagementAPI.Account {
    ...
    */
    public enum UsersUpdate {

        public static let service = APIService<Response>(id: "users_update", tag: "account", method: "PATCH", path: "/v0.1/user", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(user: User) {
                self.user = user
                super.init(service: UsersUpdate.service) {
