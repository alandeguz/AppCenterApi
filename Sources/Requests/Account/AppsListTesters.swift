...
extension EngagementAPI.Account {
    ...
    */
    public enum AppsListTesters {

        public static let service = APIService<Response>(id: "apps_listTesters", tag: "account", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/testers", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppsListTesters.service)
            }
