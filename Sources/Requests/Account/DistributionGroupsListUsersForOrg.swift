...
extension EngagementAPI.Account {
    ...
    */
    public enum DistributionGroupsListUsersForOrg {

        public static let service = APIService<Response>(id: "distributionGroups_listUsersForOrg", tag: "account", method: "GET", path: "/v0.1/orgs/{org_name}/distribution_groups/{distribution_group_name}/members", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DistributionGroupsListUsersForOrg.service)
            }
