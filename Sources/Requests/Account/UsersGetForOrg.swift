...
extension EngagementAPI.Account {
    ...
    */
    public enum UsersGetForOrg {

        public static let service = APIService<Response>(id: "users_getForOrg", tag: "account", method: "GET", path: "/v0.1/orgs/{org_name}/users/{user_name}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UsersGetForOrg.service)
            }
