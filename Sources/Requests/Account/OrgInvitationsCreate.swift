...
extension EngagementAPI.Account {
    ...
    */
    public enum OrgInvitationsCreate {

        public static let service = APIService<Response>(id: "orgInvitations_create", tag: "account", method: "POST", path: "/v0.1/orgs/{org_name}/invitations", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(userEmail: UserEmail?, options: Options) {
                ...
                super.init(service: OrgInvitationsCreate.service) {
