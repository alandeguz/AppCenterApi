...
extension EngagementAPI.Account {
    ...
    */
    public enum UsersList {
        ...
        public static let service = APIService<Response>(id: "users_list", tag: "account", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/users", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UsersList.service)
            }
