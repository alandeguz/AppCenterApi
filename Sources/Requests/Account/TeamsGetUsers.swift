...
extension EngagementAPI.Account {
    ...
    */
    public enum TeamsGetUsers {

        public static let service = APIService<Response>(id: "teams_getUsers", tag: "account", method: "GET", path: "/v0.1/orgs/{org_name}/teams/{team_name}/users", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: TeamsGetUsers.service)
            }
