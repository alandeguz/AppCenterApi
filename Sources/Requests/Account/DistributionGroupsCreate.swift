...
extension EngagementAPI.Account {
    ...
    */
    public enum DistributionGroupsCreate {

        public static let service = APIService<Response>(id: "distributionGroups_create", tag: "account", method: "POST", path: "/v0.1/apps/{owner_name}/{app_name}/distribution_groups", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(distributionGroup: DistributionGroup, options: Options) {
                ...
                super.init(service: DistributionGroupsCreate.service) {
            ...
            public convenience init(ownerName: String, appName: String, distributionGroup: DistributionGroup) {
