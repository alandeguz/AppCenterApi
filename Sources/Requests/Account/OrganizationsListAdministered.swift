...
extension EngagementAPI.Account {
    ...
    */
    public enum OrganizationsListAdministered {

        public static let service = APIService<Response>(id: "organizations_listAdministered", tag: "account", method: "GET", path: "/v0.1/administeredOrgs", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: OrganizationsListAdministered.service)
            }
        }
