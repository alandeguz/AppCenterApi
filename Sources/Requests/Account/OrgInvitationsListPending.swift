...
extension EngagementAPI.Account {
    ...
    */
    public enum OrgInvitationsListPending {

        public static let service = APIService<Response>(id: "orgInvitations_listPending", tag: "account", method: "GET", path: "/v0.1/orgs/{org_name}/invitations", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: OrgInvitationsListPending.service)
            }
