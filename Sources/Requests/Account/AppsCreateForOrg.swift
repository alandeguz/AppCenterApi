...
extension EngagementAPI.Account {
    ...
    */
    public enum AppsCreateForOrg {

        public static let service = APIService<Response>(id: "apps_createForOrg", tag: "account", method: "POST", path: "/v0.1/orgs/{org_name}/apps", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(app: App, options: Options) {
                ...
                super.init(service: AppsCreateForOrg.service) {
            ...
            public convenience init(orgName: String, app: App) {
