...
extension EngagementAPI.Account {
    ...
    */
    public enum AzureSubscriptionListForApp {

        public static let service = APIService<Response>(id: "azureSubscription_listForApp", tag: "account", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/azure_subscriptions", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AzureSubscriptionListForApp.service)
            }
