...
extension EngagementAPI.Account {
    ...
    */
    public enum AppsList {
        ...
        public static let service = APIService<Response>(id: "apps_list", tag: "account", method: "GET", path: "/v0.1/apps", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public enum dollarorderBy: String, Codable {
            case displayName = "display_name"
            case name = "name"

            public static let cases: [dollarorderBy] = [
              .displayName,
              .name,
            ]
        }
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                /** The name of the attribute by which to order the response by. By default, apps are in order of creation. All results are ordered in ascending order. */
                public var dollarorderBy: dollarorderBy?

                public init(dollarorderBy: dollarorderBy? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppsList.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(dollarorderBy: dollarorderBy? = nil) {
                let options = Options(dollarorderBy: dollarorderBy)
