...
extension EngagementAPI.Account {
    ...
    */
    public enum AppInvitationsCreate {

        public static let service = APIService<Response>(id: "appInvitations_create", tag: "account", method: "POST", path: "/v0.1/apps/{owner_name}/{app_name}/invitations", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(userEmail: UserEmail?, options: Options) {
                ...
                super.init(service: AppInvitationsCreate.service) {
            ...
            public convenience init(ownerName: String, appName: String, userEmail: UserEmail? = nil) {
