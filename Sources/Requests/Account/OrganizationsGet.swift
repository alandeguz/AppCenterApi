...
extension EngagementAPI.Account {
    ...
    */
    public enum OrganizationsGet {

        public static let service = APIService<Response>(id: "organizations_get", tag: "account", method: "GET", path: "/v0.1/orgs/{org_name}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: OrganizationsGet.service)
            }
