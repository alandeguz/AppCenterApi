...
extension EngagementAPI.Account {
    ...
    */
    public enum AppsListForOrg {

        public static let service = APIService<Response>(id: "apps_listForOrg", tag: "account", method: "GET", path: "/v0.1/orgs/{org_name}/apps", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppsListForOrg.service)
            }
