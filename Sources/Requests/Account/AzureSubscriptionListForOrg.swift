...
extension EngagementAPI.Account {
    ...
    */
    public enum AzureSubscriptionListForOrg {

        public static let service = APIService<Response>(id: "azureSubscription_listForOrg", tag: "account", method: "GET", path: "/v0.1/orgs/{org_name}/azure_subscriptions", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AzureSubscriptionListForOrg.service)
            }
