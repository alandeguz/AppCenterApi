...
extension EngagementAPI.Account {
    ...
    */
    public enum AppInvitationsDelete {

        public static let service = APIService<Response>(id: "appInvitations_delete", tag: "account", method: "DELETE", path: "/v0.1/apps/{owner_name}/{app_name}/invitations/{user_email}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppInvitationsDelete.service)
            }
