...
extension EngagementAPI.Account {
    ...
    */
    public enum DistributionGroupsListAllTestersForOrg {

        public static let service = APIService<Response>(id: "distributionGroups_listAllTestersForOrg", tag: "account", method: "GET", path: "/v0.1/orgs/{org_name}/testers", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DistributionGroupsListAllTestersForOrg.service)
            }
