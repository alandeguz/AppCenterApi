...
extension EngagementAPI.Account {
    ...
    */
    public enum AppsTransferToOrg {

        public static let service = APIService<Response>(id: "apps_transferToOrg", tag: "account", method: "POST", path: "/v0.1/apps/{owner_name}/{app_name}/transfer_to_org", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppsTransferToOrg.service)
            }
