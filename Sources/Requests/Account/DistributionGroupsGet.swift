...
extension EngagementAPI.Account {
    ...
    */
    public enum DistributionGroupsGet {

        public static let service = APIService<Response>(id: "distributionGroups_get", tag: "account", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/distribution_groups/{distribution_group_name}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DistributionGroupsGet.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(ownerName: String, appName: String, distributionGroupName: String) {
