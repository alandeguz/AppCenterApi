...
extension EngagementAPI.Account {
    ...
    */
    public enum TeamsDelete {

        public static let service = APIService<Response>(id: "teams_delete", tag: "account", method: "DELETE", path: "/v0.1/orgs/{org_name}/teams/{team_name}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: TeamsDelete.service)
            }
