...
extension EngagementAPI.Test {
    ...
    */
    public enum TestUpdateDeviceSetOfOwner {

        public static let service = APIService<Response>(id: "test_updateDeviceSetOfOwner", tag: "test", method: "PUT", path: "/v0.1/apps/{owner_name}/{app_name}/owner/device_sets/{id}", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(deviceSet: DeviceSet, options: Options) {
                ...
                super.init(service: TestUpdateDeviceSetOfOwner.service) {
