...
extension EngagementAPI.Test {
    ...
    */
    public enum TestCreateDeviceSetOfUser {

        public static let service = APIService<Response>(id: "test_createDeviceSetOfUser", tag: "test", method: "POST", path: "/v0.1/apps/{owner_name}/{app_name}/user/device_sets", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(deviceSet: DeviceSet, options: Options) {
                ...
                super.init(service: TestCreateDeviceSetOfUser.service) {
