...
extension EngagementAPI.Test {
    ...
    */
    public enum TestCreateSubscription {

        public static let service = APIService<Response>(id: "test_createSubscription", tag: "test", method: "POST", path: "/v0.1/apps/{owner_name}/{app_name}/subscriptions", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: TestCreateSubscription.service)
            }
