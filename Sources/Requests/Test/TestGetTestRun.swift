...
extension EngagementAPI.Test {
    ...
    */
    public enum TestGetTestRun {

        public static let service = APIService<Response>(id: "test_getTestRun", tag: "test", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/test_runs/{test_run_id}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: TestGetTestRun.service)
            }
