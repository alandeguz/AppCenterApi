...
extension EngagementAPI.Test {
    ...
    */
    public enum TestArchiveTestRun {

        public static let service = APIService<Response>(id: "test_archiveTestRun", tag: "test", method: "DELETE", path: "/v0.1/apps/{owner_name}/{app_name}/test_runs/{test_run_id}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: TestArchiveTestRun.service)
            }
