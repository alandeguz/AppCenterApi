...
extension EngagementAPI.Test {
    ...
    */
    public enum TestGetTestRuns {

        public static let service = APIService<Response>(id: "test_getTestRuns", tag: "test", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/test_runs", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: TestGetTestRuns.service)
            }
