...
extension EngagementAPI.Codepush {
    ...
    */
    public enum CodePushDeploymentsUpdate {

        public static let service = APIService<Response>(id: "codePushDeployments_update", tag: "codepush", method: "PATCH", path: "/v0.1/apps/{owner_name}/{app_name}/deployments/{deployment_name}", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(deployment: Deployment, options: Options) {
                ...
                super.init(service: CodePushDeploymentsUpdate.service) {
            ...
            public convenience init(deploymentName: String, deployment: Deployment, ownerName: String, appName: String) {
