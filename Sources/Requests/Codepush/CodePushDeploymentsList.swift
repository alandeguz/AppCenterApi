...
extension EngagementAPI.Codepush {
    ...
    */
    public enum CodePushDeploymentsList {

        public static let service = APIService<Response>(id: "codePushDeployments_list", tag: "codepush", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/deployments", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: CodePushDeploymentsList.service)
            }
