...
extension EngagementAPI.Codepush {
    ...
    */
    public enum CodePushAcquisitionUpdateDownloadStatus {

        public static let service = APIService<Response>(id: "codePushAcquisition_updateDownloadStatus", tag: "codepush", method: "POST", path: "/v0.1/public/codepush/report_status/download", hasBody: true)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(releaseMetadata: ReleaseMetadata) {
                ...
                super.init(service: CodePushAcquisitionUpdateDownloadStatus.service) {
