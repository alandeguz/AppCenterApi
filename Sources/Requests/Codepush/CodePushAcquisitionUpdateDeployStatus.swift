...
extension EngagementAPI.Codepush {
    ...
    */
    public enum CodePushAcquisitionUpdateDeployStatus {

        public static let service = APIService<Response>(id: "codePushAcquisition_updateDeployStatus", tag: "codepush", method: "POST", path: "/v0.1/public/codepush/report_status/deploy", hasBody: true)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(releaseMetadata: ReleaseMetadata) {
                ...
                super.init(service: CodePushAcquisitionUpdateDeployStatus.service) {
