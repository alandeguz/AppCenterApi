...
extension EngagementAPI.Codepush {
    ...
    */
    public enum LegacyCodePushAcquisitionUpdateDownloadStatus {

        public static let service = APIService<Response>(id: "legacyCodePushAcquisition_updateDownloadStatus", tag: "codepush", method: "POST", path: "/v0.1/legacy/reportStatus/download", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(releaseMetadata: ReleaseMetadata) {
                ...
                super.init(service: LegacyCodePushAcquisitionUpdateDownloadStatus.service) {
