...
extension EngagementAPI.Codepush {
    ...
    */
    public enum CodePushDeploymentMetricsGet {

        public static let service = APIService<Response>(id: "codePushDeploymentMetrics_get", tag: "codepush", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/deployments/{deployment_name}/metrics", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: CodePushDeploymentMetricsGet.service)
            }
