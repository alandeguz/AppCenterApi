...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsTestAudience {

        public static let service = APIService<Response>(id: "Analytics_TestAudience", tag: "analytics", method: "POST", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/audiences/definition/test", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(audience: Audience, options: Options) {
                ...
                super.init(service: AnalyticsTestAudience.service) {
            ...
            public convenience init(audience: Audience, ownerName: String, appName: String) {
