...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsOperatingSystemCounts {

        public static let service = APIService<Response>(id: "Analytics_OperatingSystemCounts", tag: "analytics", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/oses", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AnalyticsOperatingSystemCounts.service)
            }
