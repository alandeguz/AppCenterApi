...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsCrashGroupOperatingSystemCounts {

        public static let service = APIService<Response>(id: "Analytics_CrashGroupOperatingSystemCounts", tag: "analytics", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/crash_groups/{crash_group_id}/operating_systems", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(crashGroupId: String, version: String, dollartop: Int? = nil, ownerName: String, appName: String) {
            ...
            public init(options: Options) {
                ...
                super.init(service: AnalyticsCrashGroupOperatingSystemCounts.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(crashGroupId: String, version: String, dollartop: Int? = nil, ownerName: String, appName: String) {
                let options = Options(crashGroupId: crashGroupId, version: version, dollartop: dollartop, ownerName: ownerName, appName: appName)
