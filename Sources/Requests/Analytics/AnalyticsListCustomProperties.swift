...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsListCustomProperties {

        public static let service = APIService<Response>(id: "Analytics_ListCustomProperties", tag: "analytics", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/audiences/metadata/custom_properties", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AnalyticsListCustomProperties.service)
            }
