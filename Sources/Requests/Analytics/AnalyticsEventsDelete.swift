...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsEventsDelete {

        public static let service = APIService<Response>(id: "Analytics_EventsDelete", tag: "analytics", method: "DELETE", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/events/{event_name}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AnalyticsEventsDelete.service)
            }
