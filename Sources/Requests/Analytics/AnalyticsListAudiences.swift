...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsListAudiences {

        public static let service = APIService<Response>(id: "Analytics_ListAudiences", tag: "analytics", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/audiences", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(includeDisabled: Bool? = nil, ownerName: String, appName: String) {
            ...
            public init(options: Options) {
                ...
                super.init(service: AnalyticsListAudiences.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(includeDisabled: Bool? = nil, ownerName: String, appName: String) {
                let options = Options(includeDisabled: includeDisabled, ownerName: ownerName, appName: appName)
            ...
            public override var parameters: [String: Any] {
                ...
                if let includeDisabled = options.includeDisabled {
