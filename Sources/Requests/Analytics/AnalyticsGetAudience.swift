...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsGetAudience {

        public static let service = APIService<Response>(id: "Analytics_GetAudience", tag: "analytics", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/audiences/{audience_name}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AnalyticsGetAudience.service)
            }
