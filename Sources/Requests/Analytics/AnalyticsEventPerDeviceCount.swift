...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsEventPerDeviceCount {

        public static let service = APIService<Response>(id: "Analytics_EventPerDeviceCount", tag: "analytics", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/events/{event_name}/count_per_device", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AnalyticsEventPerDeviceCount.service)
            }
