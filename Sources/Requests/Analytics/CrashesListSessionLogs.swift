...
extension EngagementAPI.Analytics {
    ...
    */
    public enum CrashesListSessionLogs {

        public static let service = APIService<Response>(id: "Crashes_ListSessionLogs", tag: "analytics", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/crashes/{crash_id}/session_logs", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(crashId: String, date: DateTime? = nil, ownerName: String, appName: String) {
            ...
            public init(options: Options) {
                ...
                super.init(service: CrashesListSessionLogs.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(crashId: String, date: DateTime? = nil, ownerName: String, appName: String) {
                let options = Options(crashId: crashId, date: date, ownerName: ownerName, appName: appName)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "crashId" + "}", with: "\(self.options.crashId)").replacingOccurrences(of: "{" + "ownerName" + "}", with: "\(self.options.ownerName)").replacingOccurrences(of: "{" + "appName" + "}", with: "\(self.options.appName)")
            }
