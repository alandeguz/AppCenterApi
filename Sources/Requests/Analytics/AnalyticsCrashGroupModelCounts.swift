...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsCrashGroupModelCounts {

        public static let service = APIService<Response>(id: "Analytics_CrashGroupModelCounts", tag: "analytics", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/crash_groups/{crash_group_id}/models", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AnalyticsCrashGroupModelCounts.service)
            }
