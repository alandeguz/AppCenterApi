...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsCrashGroupCounts {

        public static let service = APIService<Response>(id: "Analytics_CrashGroupCounts", tag: "analytics", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/crash_groups/{crash_group_id}/crash_counts", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(crashGroupId: String, version: String, start: DateTime, end: DateTime? = nil, ownerName: String, appName: String) {
            ...
            public init(options: Options) {
                ...
                super.init(service: AnalyticsCrashGroupCounts.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(crashGroupId: String, version: String, start: DateTime, end: DateTime? = nil, ownerName: String, appName: String) {
                let options = Options(crashGroupId: crashGroupId, version: version, start: start, end: end, ownerName: ownerName, appName: appName)
