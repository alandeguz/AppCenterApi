...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsCrashCounts {

        public static let service = APIService<Response>(id: "Analytics_CrashCounts", tag: "analytics", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/crash_counts", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AnalyticsCrashCounts.service)
            }
