...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsEventCount {

        public static let service = APIService<Response>(id: "Analytics_EventCount", tag: "analytics", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/events/{event_name}/event_count", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AnalyticsEventCount.service)
            }
