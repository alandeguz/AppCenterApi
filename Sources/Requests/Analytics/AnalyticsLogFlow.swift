...
extension EngagementAPI.Analytics {
    ...
    */
    public enum AnalyticsLogFlow {

        public static let service = APIService<Response>(id: "Analytics_LogFlow", tag: "analytics", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/analytics/log_flow", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AnalyticsLogFlow.service)
            }
