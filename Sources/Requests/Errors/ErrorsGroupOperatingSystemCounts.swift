...
extension EngagementAPI.Errors {
    ...
    */
    public enum ErrorsGroupOperatingSystemCounts {

        public static let service = APIService<Response>(id: "Errors_GroupOperatingSystemCounts", tag: "errors", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/errors/errorGroups/{errorGroupId}/operatingSystems", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(errorGroupId: String, dollartop: Int? = nil, ownerName: String, appName: String) {
            ...
            public init(options: Options) {
                ...
                super.init(service: ErrorsGroupOperatingSystemCounts.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(errorGroupId: String, dollartop: Int? = nil, ownerName: String, appName: String) {
                let options = Options(errorGroupId: errorGroupId, dollartop: dollartop, ownerName: ownerName, appName: appName)
