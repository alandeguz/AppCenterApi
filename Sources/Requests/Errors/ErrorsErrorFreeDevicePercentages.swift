...
extension EngagementAPI.Errors {
    ...
    */
    public enum ErrorsErrorFreeDevicePercentages {

        public static let service = APIService<Response>(id: "Errors_ErrorFreeDevicePercentages", tag: "errors", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/errors/errorfreeDevicePercentages", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(start: DateTime, end: DateTime? = nil, versions: [String]? = nil, appBuild: String? = nil, errorType: SingleErrorTypeParameter? = nil, ownerName: String, appName: String) {
                    self.start = start
                    self.end = end
            ...
            public init(options: Options) {
                ...
                super.init(service: ErrorsErrorFreeDevicePercentages.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(start: DateTime, end: DateTime? = nil, versions: [String]? = nil, appBuild: String? = nil, errorType: SingleErrorTypeParameter? = nil, ownerName: String, appName: String) {
                let options = Options(start: start, end: end, versions: versions, appBuild: appBuild, errorType: errorType, ownerName: ownerName, appName: appName)
