...
extension EngagementAPI.Errors {
    ...
    */
    public enum ErrorsErrorDownload {

        public static let service = APIService<Response>(id: "Errors_ErrorDownload", tag: "errors", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/errors/errorGroups/{errorGroupId}/errors/{errorId}/download", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public var format: FormatParameter?
                ...
                public init(errorGroupId: String, errorId: String, format: FormatParameter? = nil, ownerName: String, appName: String) {
            ...
            public init(options: Options) {
                ...
                super.init(service: ErrorsErrorDownload.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(errorGroupId: String, errorId: String, format: FormatParameter? = nil, ownerName: String, appName: String) {
                let options = Options(errorGroupId: errorGroupId, errorId: errorId, format: format, ownerName: ownerName, appName: appName)
