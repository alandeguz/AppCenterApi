...
extension EngagementAPI.Errors {
    ...
    Error details.
    */
    public enum ErrorsGetErrorDetails {

        public static let service = APIService<Response>(id: "Errors_GetErrorDetails", tag: "errors", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/errors/errorGroups/{errorGroupId}/errors/{errorId}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ErrorsGetErrorDetails.service)
            }
