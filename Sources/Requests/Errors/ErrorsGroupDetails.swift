...
extension EngagementAPI.Errors {
    ...
    Error group details
    */
    public enum ErrorsGroupDetails {

        public static let service = APIService<Response>(id: "Errors_GroupDetails", tag: "errors", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/errors/errorGroups/{errorGroupId}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ErrorsGroupDetails.service)
            }
