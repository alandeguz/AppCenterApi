...
extension EngagementAPI.Errors {
    ...
    */
    public enum ErrorsListSessionLogs {

        public static let service = APIService<Response>(id: "Errors_ListSessionLogs", tag: "errors", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/errors/{errorId}/sessionLogs", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(errorId: String, date: DateTime? = nil, ownerName: String, appName: String) {
            ...
            public init(options: Options) {
                ...
                super.init(service: ErrorsListSessionLogs.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(errorId: String, date: DateTime? = nil, ownerName: String, appName: String) {
                let options = Options(errorId: errorId, date: date, ownerName: ownerName, appName: appName)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "errorId" + "}", with: "\(self.options.errorId)").replacingOccurrences(of: "{" + "ownerName" + "}", with: "\(self.options.ownerName)").replacingOccurrences(of: "{" + "appName" + "}", with: "\(self.options.appName)")
            }
