...
extension EngagementAPI.Errors {
    ...
    */
    public enum ErrorsGroupModelCounts {

        public static let service = APIService<Response>(id: "Errors_GroupModelCounts", tag: "errors", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/errors/errorGroups/{errorGroupId}/models", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ErrorsGroupModelCounts.service)
            }
