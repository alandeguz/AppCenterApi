...
extension EngagementAPI.Errors {
    ...
    */
    public enum ErrorsGetRetentionSettings {

        public static let service = APIService<Response>(id: "errors_getRetentionSettings", tag: "errors", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/errors/retention_settings", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ErrorsGetRetentionSettings.service)
            }
