...
extension EngagementAPI.Errors {
    ...
    Error location.
    */
    public enum ErrorsErrorLocation {

        public static let service = APIService<Response>(id: "Errors_ErrorLocation", tag: "errors", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/errors/errorGroups/{errorGroupId}/errors/{errorId}/location", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ErrorsErrorLocation.service)
            }
