...
extension EngagementAPI.Push {
    ...
    */
    public enum PushConfigExists {

        public static let service = APIService<Response>(id: "Push_ConfigExists", tag: "push", method: "HEAD", path: "/v0.1/apps/{owner_name}/{app_name}/push/notifications_config", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: PushConfigExists.service)
            }
