...
extension EngagementAPI.Push {
    ...
    */
    public enum PushExportDevices {

        public static let service = APIService<Response>(id: "Push_ExportDevices", tag: "push", method: "POST", path: "/v0.1/apps/{owner_name}/{app_name}/push/device_exports", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(properties: Properties, options: Options) {
                ...
                super.init(service: PushExportDevices.service) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Export operation successfully started */
