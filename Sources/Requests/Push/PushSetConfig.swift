...
extension EngagementAPI.Push {
    ...
    */
    public enum PushSetConfig {

        public static let service = APIService<Response>(id: "Push_SetConfig", tag: "push", method: "PUT", path: "/v0.1/apps/{owner_name}/{app_name}/push/notifications_config", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(properties: Properties, options: Options) {
                ...
                super.init(service: PushSetConfig.service) {
