...
extension EngagementAPI.Crash {
    ...
    */
    public enum SymbolUploadsGetLocation {

        public static let service = APIService<Response>(id: "symbolUploads_getLocation", tag: "crash", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/symbol_uploads/{symbol_upload_id}/location", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: SymbolUploadsGetLocation.service)
            }
