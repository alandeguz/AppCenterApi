...
extension EngagementAPI.Crash {
    ...
    */
    public enum CrashGroupsGetStacktrace {

        public static let service = APIService<Response>(id: "crashGroups_getStacktrace", tag: "crash", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/crash_groups/{crash_group_id}/stacktrace", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(crashGroupId: String, groupingOnly: Bool? = nil, ownerName: String, appName: String) {
            ...
            public init(options: Options) {
                ...
                super.init(service: CrashGroupsGetStacktrace.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(crashGroupId: String, groupingOnly: Bool? = nil, ownerName: String, appName: String) {
                let options = Options(crashGroupId: crashGroupId, groupingOnly: groupingOnly, ownerName: ownerName, appName: appName)
