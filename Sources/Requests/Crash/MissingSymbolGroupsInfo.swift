...
extension EngagementAPI.Crash {
    ...
    */
    public enum MissingSymbolGroupsInfo {

        public static let service = APIService<Response>(id: "missingSymbolGroups_info", tag: "crash", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/diagnostics/symbol_groups_info", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: MissingSymbolGroupsInfo.service)
            }
