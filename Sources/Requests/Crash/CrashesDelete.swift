...
extension EngagementAPI.Crash {
    ...
    */
    public enum CrashesDelete {

        public static let service = APIService<Response>(id: "crashes_delete", tag: "crash", method: "DELETE", path: "/v0.1/apps/{owner_name}/{app_name}/crash_groups/{crash_group_id}/crashes/{crash_id}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public var retentionDelete: Bool?
                ...
                public init(crashGroupId: String, crashId: String, retentionDelete: Bool? = nil, ownerName: String, appName: String) {
                    self.crashGroupId = crashGroupId
                    self.crashId = crashId
                    self.retentionDelete = retentionDelete
            ...
            public init(options: Options) {
                ...
                super.init(service: CrashesDelete.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(crashGroupId: String, crashId: String, retentionDelete: Bool? = nil, ownerName: String, appName: String) {
                let options = Options(crashGroupId: crashGroupId, crashId: crashId, retentionDelete: retentionDelete, ownerName: ownerName, appName: appName)
            ...
            public override var parameters: [String: Any] {
                ...
                if let retentionDelete = options.retentionDelete {
                  params["retention_delete"] = retentionDelete
                }
                return params
            }
        }
