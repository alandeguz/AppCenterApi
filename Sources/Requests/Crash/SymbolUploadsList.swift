...
extension EngagementAPI.Crash {
    ...
    */
    public enum SymbolUploadsList {

        public static let service = APIService<Response>(id: "symbolUploads_list", tag: "crash", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/symbol_uploads", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
 ...
 */
                ...
                public init(top: Int? = nil, status: Status? = nil, symbolType: SymbolType? = nil, ownerName: String, appName: String) {
                    self.top = top
                    self.status = status
            ...
            public init(options: Options) {
                ...
                super.init(service: SymbolUploadsList.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(top: Int? = nil, status: Status? = nil, symbolType: SymbolType? = nil, ownerName: String, appName: String) {
                let options = Options(top: top, status: status, symbolType: symbolType, ownerName: ownerName, appName: appName)
            ...
            public override var parameters: [String: Any] {
                ...
                if let symbolType = options.symbolType?.encode() {
                  params["symbol_type"] = symbolType
                }
                return params
            }
        }
