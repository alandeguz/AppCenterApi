...
extension EngagementAPI.Crash {
    ...
    */
    public enum CrashGroupsGet {

        public static let service = APIService<Response>(id: "crashGroups_get", tag: "crash", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/crash_groups/{crash_group_id}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: CrashGroupsGet.service)
            }
