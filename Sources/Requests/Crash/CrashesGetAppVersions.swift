...
extension EngagementAPI.Crash {
    ...
    */
    public enum CrashesGetAppVersions {

        public static let service = APIService<Response>(id: "crashes_getAppVersions", tag: "crash", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/versions", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: CrashesGetAppVersions.service)
            }
