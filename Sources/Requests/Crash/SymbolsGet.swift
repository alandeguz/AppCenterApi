...
extension EngagementAPI.Crash {
    ...
    */
    public enum SymbolsGet {

        public static let service = APIService<Response>(id: "symbols_get", tag: "crash", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/symbols/{symbol_id}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: SymbolsGet.service)
            }
