...
extension EngagementAPI.Build {
    ...
    */
    public enum RepositoryConfigurationsCreateOrUpdate {

        public static let service = APIService<Response>(id: "repositoryConfigurations_createOrUpdate", tag: "build", method: "POST", path: "/v0.1/apps/{owner_name}/{app_name}/repo_config", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(repo: Repo, options: Options) {
                self.repo = repo
                self.options = options
                super.init(service: RepositoryConfigurationsCreateOrUpdate.service) {
                    let jsonEncoder = JSONEncoder()
                    return try jsonEncoder.encode(repo)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(repo: Repo, ownerName: String, appName: String) {
                let options = Options(ownerName: ownerName, appName: appName)
                self.init(repo: repo, options: options)
            }
