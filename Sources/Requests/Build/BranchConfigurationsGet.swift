...
extension EngagementAPI.Build {
    ...
    */
    public enum BranchConfigurationsGet {

        public static let service = APIService<Response>(id: "branchConfigurations_get", tag: "build", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/branches/{branch}/config", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BranchConfigurationsGet.service)
            }
