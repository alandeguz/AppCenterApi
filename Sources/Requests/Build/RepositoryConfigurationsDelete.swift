...
extension EngagementAPI.Build {
    ...
    */
    public enum RepositoryConfigurationsDelete {

        public static let service = APIService<Response>(id: "repositoryConfigurations_delete", tag: "build", method: "DELETE", path: "/v0.1/apps/{owner_name}/{app_name}/repo_config", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: RepositoryConfigurationsDelete.service)
            }
