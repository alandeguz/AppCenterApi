...
extension EngagementAPI.Build {
    ...
    */
    public enum BuildsListXamarinSDKBundles {

        public static let service = APIService<Response>(id: "builds_listXamarinSDKBundles", tag: "build", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/xamarin_sdk_bundles", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildsListXamarinSDKBundles.service)
            }
