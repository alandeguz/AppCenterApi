...
extension EngagementAPI.Gdpr {
    ...
    public enum DataSubjectRightDeleteRequest {

        public static let service = APIService<Response>(id: "DataSubjectRight_DeleteRequest", tag: "gdpr", method: "POST", path: "/v0.1/user/dsr/delete", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: DataSubjectRightDeleteRequest.service)
            }
        }
