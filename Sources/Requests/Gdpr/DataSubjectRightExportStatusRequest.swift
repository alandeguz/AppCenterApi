...
extension EngagementAPI.Gdpr {
    ...
    public enum DataSubjectRightExportStatusRequest {

        public static let service = APIService<Response>(id: "DataSubjectRight_ExportStatusRequest", tag: "gdpr", method: "GET", path: "/v0.1/user/dsr/export/{token}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DataSubjectRightExportStatusRequest.service)
            }
