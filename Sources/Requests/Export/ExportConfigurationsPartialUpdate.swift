...
extension EngagementAPI.Export {
    ...
    */
    public enum ExportConfigurationsPartialUpdate {

        public static let service = APIService<Response>(id: "ExportConfigurations_PartialUpdate", tag: "export", method: "PATCH", path: "/v0.1/apps/{owner_name}/{app_name}/export_configurations/{export_configuration_id}", hasBody: true, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(properties: Properties, options: Options) {
                ...
                super.init(service: ExportConfigurationsPartialUpdate.service) {
            ...
            public convenience init(exportConfigurationId: String, properties: Properties, ownerName: String, appName: String) {
