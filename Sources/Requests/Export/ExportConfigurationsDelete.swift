...
extension EngagementAPI.Export {
    ...
    */
    public enum ExportConfigurationsDelete {

        public static let service = APIService<Response>(id: "ExportConfigurations_Delete", tag: "export", method: "DELETE", path: "/v0.1/apps/{owner_name}/{app_name}/export_configurations/{export_configuration_id}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ExportConfigurationsDelete.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Export configuration was successfully deleted. */
            case status200
