...
extension EngagementAPI.Export {
    ...
    */
    public enum ExportConfigurationsGet {

        public static let service = APIService<Response>(id: "ExportConfigurations_Get", tag: "export", method: "GET", path: "/v0.1/apps/{owner_name}/{app_name}/export_configurations/{export_configuration_id}", hasBody: false, securityRequirement: SecurityRequirement(type: "APIToken", scope: ""))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ExportConfigurationsGet.service)
            }
