...
public class StartServiceLog: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? StartServiceLog else { return false }
      guard self.services == object.services else { return false }
      return true
    }

    public static func == (lhs: StartServiceLog, rhs: StartServiceLog) -> Bool {
