...
public class DiagnosticsThread: APIModel {
    ...
    public init(title: String, frames: [Frames], crashed: Bool? = nil, exception: DiagnosticsException? = nil, platform: Platform? = nil, relevant: Bool? = nil) {
        self.title = title
        self.frames = frames
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? DiagnosticsThread else { return false }
    ...
    public static func == (lhs: DiagnosticsThread, rhs: DiagnosticsThread) -> Bool {
