...
public class DiagnosticsStackFrame: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? DiagnosticsStackFrame else { return false }
    ...
    public static func == (lhs: DiagnosticsStackFrame, rhs: DiagnosticsStackFrame) -> Bool {
