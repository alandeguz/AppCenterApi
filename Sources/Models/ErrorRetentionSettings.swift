...
public class ErrorRetentionSettings: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ErrorRetentionSettings else { return false }
      guard self.retentionInDays == object.retentionInDays else { return false }
      return true
    }

    public static func == (lhs: ErrorRetentionSettings, rhs: ErrorRetentionSettings) -> Bool {
