...
public class CreateAccessKeyResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CreateAccessKeyResponse else { return false }
      guard self.accessKey == object.accessKey else { return false }
      return true
    }

    public static func == (lhs: CreateAccessKeyResponse, rhs: CreateAccessKeyResponse) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
