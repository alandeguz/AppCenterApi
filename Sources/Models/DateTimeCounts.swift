...
public class DateTimeCounts: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? DateTimeCounts else { return false }
      guard self.count == object.count else { return false }
      guard self.datetime == object.datetime else { return false }
      return true
    }

    public static func == (lhs: DateTimeCounts, rhs: DateTimeCounts) -> Bool {
