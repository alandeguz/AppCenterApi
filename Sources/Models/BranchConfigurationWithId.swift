...
public class BranchConfigurationWithId: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? BranchConfigurationWithId else { return false }
    ...
    public static func == (lhs: BranchConfigurationWithId, rhs: BranchConfigurationWithId) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
