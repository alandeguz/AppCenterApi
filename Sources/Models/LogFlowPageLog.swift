...
public class LogFlowPageLog: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? LogFlowPageLog else { return false }
      guard self.name == object.name else { return false }
      guard self.sessionId == object.sessionId else { return false }
      return true
    }

    public static func == (lhs: LogFlowPageLog, rhs: LogFlowPageLog) -> Bool {
