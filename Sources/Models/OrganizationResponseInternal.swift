...
public class OrganizationResponseInternal: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? OrganizationResponseInternal else { return false }
    ...
    public static func == (lhs: OrganizationResponseInternal, rhs: OrganizationResponseInternal) -> Bool {
