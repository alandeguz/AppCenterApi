...
public class DeleteReleasesContainer: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? DeleteReleasesContainer else { return false }
      guard self.releases == object.releases else { return false }
      return true
    }

    public static func == (lhs: DeleteReleasesContainer, rhs: DeleteReleasesContainer) -> Bool {
