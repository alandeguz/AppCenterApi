...
public class UpdateInfoData: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? UpdateInfoData else { return false }
    ...
    public static func == (lhs: UpdateInfoData, rhs: UpdateInfoData) -> Bool {
