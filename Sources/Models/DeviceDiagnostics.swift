...
public class DeviceDiagnostics: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? DeviceDiagnostics else { return false }
    ...
    public static func == (lhs: DeviceDiagnostics, rhs: DeviceDiagnostics) -> Bool {
