...
public class DistributionGroupRelease: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? DistributionGroupRelease else { return false }
    ...
    public static func == (lhs: DistributionGroupRelease, rhs: DistributionGroupRelease) -> Bool {
