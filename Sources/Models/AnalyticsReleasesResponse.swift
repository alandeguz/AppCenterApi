...
public class AnalyticsReleasesResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? AnalyticsReleasesResponse else { return false }
      guard self.releases == object.releases else { return false }
      return true
    }

    public static func == (lhs: AnalyticsReleasesResponse, rhs: AnalyticsReleasesResponse) -> Bool {
