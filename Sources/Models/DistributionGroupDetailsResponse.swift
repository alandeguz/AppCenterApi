...
public class DistributionGroupDetailsResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? DistributionGroupDetailsResponse else { return false }
    ...
    public static func == (lhs: DistributionGroupDetailsResponse, rhs: DistributionGroupDetailsResponse) -> Bool {
