...
/** a exception */
public class DiagnosticsException: APIModel {
    ...
    public init(frames: [Frames], innerExceptions: [DiagnosticsException]? = nil, platform: Platform? = nil, reason: String? = nil, relevant: Bool? = nil, type: String? = nil) {
        self.frames = frames
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? DiagnosticsException else { return false }
    ...
    public static func == (lhs: DiagnosticsException, rhs: DiagnosticsException) -> Bool {
