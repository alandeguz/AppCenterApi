...
public class UserProfileResponseInternal: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? UserProfileResponseInternal else { return false }
    ...
    public static func == (lhs: UserProfileResponseInternal, rhs: UserProfileResponseInternal) -> Bool {
