...
public class ReleaseDetailsResponse: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ReleaseDetailsResponse else { return false }
    ...
    public static func == (lhs: ReleaseDetailsResponse, rhs: ReleaseDetailsResponse) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
