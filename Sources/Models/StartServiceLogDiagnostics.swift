...
public class StartServiceLogDiagnostics: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? StartServiceLogDiagnostics else { return false }
      guard self.services == object.services else { return false }
      return true
    }

    public static func == (lhs: StartServiceLogDiagnostics, rhs: StartServiceLogDiagnostics) -> Bool {
