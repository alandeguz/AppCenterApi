...
public class AllAccountsAggregatedBillingInformation: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? AllAccountsAggregatedBillingInformation else { return false }
      guard self.aggregatedBillings == object.aggregatedBillings else { return false }
      return true
    }

    public static func == (lhs: AllAccountsAggregatedBillingInformation, rhs: AllAccountsAggregatedBillingInformation) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
