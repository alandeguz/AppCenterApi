...
public class GenericLogContainerDiagnostics: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? GenericLogContainerDiagnostics else { return false }
    ...
    public static func == (lhs: GenericLogContainerDiagnostics, rhs: GenericLogContainerDiagnostics) -> Bool {
