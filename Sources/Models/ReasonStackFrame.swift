...
public class ReasonStackFrame: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ReasonStackFrame else { return false }
    ...
    public static func == (lhs: ReasonStackFrame, rhs: ReasonStackFrame) -> Bool {
