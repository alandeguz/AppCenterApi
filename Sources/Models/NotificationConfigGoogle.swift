...
public class NotificationConfigGoogle: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? NotificationConfigGoogle else { return false }
      guard self.googleApiKey == object.googleApiKey else { return false }
      return true
    }

    public static func == (lhs: NotificationConfigGoogle, rhs: NotificationConfigGoogle) -> Bool {
