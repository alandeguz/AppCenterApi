...
public class VersionDiagnostics: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? VersionDiagnostics else { return false }
    ...
    public static func == (lhs: VersionDiagnostics, rhs: VersionDiagnostics) -> Bool {
