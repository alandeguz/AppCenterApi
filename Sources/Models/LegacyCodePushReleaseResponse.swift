...
public class LegacyCodePushReleaseResponse: APIModel {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        package = try container.decode(.package)
    }
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? LegacyCodePushReleaseResponse else { return false }
      guard self.package == object.package else { return false }
      return true
    }

    public static func == (lhs: LegacyCodePushReleaseResponse, rhs: LegacyCodePushReleaseResponse) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
