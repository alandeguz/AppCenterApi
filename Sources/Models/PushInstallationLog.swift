...
public class PushInstallationLog: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PushInstallationLog else { return false }
      guard self.pushToken == object.pushToken else { return false }
      return true
    }

    public static func == (lhs: PushInstallationLog, rhs: PushInstallationLog) -> Bool {
