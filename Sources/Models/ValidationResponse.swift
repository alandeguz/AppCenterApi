...
public class ValidationResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ValidationResponse else { return false }
      guard self.appId == object.appId else { return false }
      guard self.status == object.status else { return false }
      return true
    }

    public static func == (lhs: ValidationResponse, rhs: ValidationResponse) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
