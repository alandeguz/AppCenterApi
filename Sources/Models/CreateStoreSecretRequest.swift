...
public class CreateStoreSecretRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CreateStoreSecretRequest else { return false }
      guard self.secretJson == object.secretJson else { return false }
      guard self.tenantId == object.tenantId else { return false }
      return true
    }

    public static func == (lhs: CreateStoreSecretRequest, rhs: CreateStoreSecretRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
