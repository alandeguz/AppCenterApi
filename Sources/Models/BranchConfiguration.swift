...
public class BranchConfiguration: APIModel {
    ...
    public enum Trigger: String, Codable {
        ...
        public static let cases: [Trigger] = [
          .continous,
          .continuous,
          .manual,
        ]
    ...
    /** The branch build configuration */
    public class ArtifactVersioning: APIModel {
        ...
        public required init(from decoder: Decoder) throws {
            ...
            additionalProperties.removeValue(forKey: "buildNumberFormat")
        ...
        public func isEqual(to object: Any?) -> Bool {
          guard let object = object as? ArtifactVersioning else { return false }
        ...
        public static func == (lhs: ArtifactVersioning, rhs: ArtifactVersioning) -> Bool {
    ...
    public class Toolsets: APIModel {
        ...
        public class Android: APIModel {
            ...
            public required init(from decoder: Decoder) throws {
                ...
                let additionalPropertiesContainer = try decoder.container(keyedBy: StringCodingKey.self)
                var additionalProperties = try additionalPropertiesContainer.toDictionary()
                additionalProperties.removeValue(forKey: "automaticSigning")
                additionalProperties.removeValue(forKey: "buildVariant")
                additionalProperties.removeValue(forKey: "gradleWrapperPath")
                additionalProperties.removeValue(forKey: "isRoot")
                additionalProperties.removeValue(forKey: "keyAlias")
                additionalProperties.removeValue(forKey: "keyPassword")
                additionalProperties.removeValue(forKey: "keystoreEncoded")
                additionalProperties.removeValue(forKey: "keystoreFilename")
                additionalProperties.removeValue(forKey: "keystorePassword")
                additionalProperties.removeValue(forKey: "module")
                additionalProperties.removeValue(forKey: "runLint")
                additionalProperties.removeValue(forKey: "runTests")
                var decodedAdditionalProperties: [String: Anonymous] = [:]
                for key in additionalProperties.keys {
                    decodedAdditionalProperties[key] = try additionalPropertiesContainer.decode(StringCodingKey(string: key))
                }
        ...
        public class Javascript: APIModel {
            ...
            public required init(from decoder: Decoder) throws {
                ...
                let additionalPropertiesContainer = try decoder.container(keyedBy: StringCodingKey.self)
                var additionalProperties = try additionalPropertiesContainer.toDictionary()
                additionalProperties.removeValue(forKey: "packageJsonPath")
                additionalProperties.removeValue(forKey: "reactNativeVersion")
                additionalProperties.removeValue(forKey: "runTests")
                var decodedAdditionalProperties: [String: Anonymous] = [:]
                for key in additionalProperties.keys {
                    decodedAdditionalProperties[key] = try additionalPropertiesContainer.decode(StringCodingKey(string: key))
         ...
         */
            ...
            public required init(from decoder: Decoder) throws {
                ...
                let additionalPropertiesContainer = try decoder.container(keyedBy: StringCodingKey.self)
                var additionalProperties = try additionalPropertiesContainer.toDictionary()
                additionalProperties.removeValue(forKey: "args")
                additionalProperties.removeValue(forKey: "configuration")
                additionalProperties.removeValue(forKey: "isSimBuild")
                additionalProperties.removeValue(forKey: "monoVersion")
                additionalProperties.removeValue(forKey: "p12File")
                additionalProperties.removeValue(forKey: "p12Pwd")
                additionalProperties.removeValue(forKey: "provProfile")
                additionalProperties.removeValue(forKey: "sdkBundle")
                additionalProperties.removeValue(forKey: "slnPath")
                additionalProperties.removeValue(forKey: "symlink")
                var decodedAdditionalProperties: [String: Anonymous] = [:]
                for key in additionalProperties.keys {
                    decodedAdditionalProperties[key] = try additionalPropertiesContainer.decode(StringCodingKey(string: key))
                }
         ...
         */
            ...
            public required init(from decoder: Decoder) throws {
                ...
                let additionalPropertiesContainer = try decoder.container(keyedBy: StringCodingKey.self)
                var additionalProperties = try additionalPropertiesContainer.toDictionary()
                additionalProperties.removeValue(forKey: "appExtensionProvisioningProfileFiles")
                additionalProperties.removeValue(forKey: "archiveConfiguration")
                additionalProperties.removeValue(forKey: "automaticSigning")
                additionalProperties.removeValue(forKey: "cartfilePath")
                additionalProperties.removeValue(forKey: "certificateEncoded")
                additionalProperties.removeValue(forKey: "certificateFileId")
                additionalProperties.removeValue(forKey: "certificateFilename")
                additionalProperties.removeValue(forKey: "certificatePassword")
                additionalProperties.removeValue(forKey: "certificateUploadId")
                additionalProperties.removeValue(forKey: "forceLegacyBuildSystem")
                additionalProperties.removeValue(forKey: "podfilePath")
                additionalProperties.removeValue(forKey: "projectOrWorkspacePath")
                additionalProperties.removeValue(forKey: "provisioningProfileEncoded")
                additionalProperties.removeValue(forKey: "provisioningProfileFileId")
                additionalProperties.removeValue(forKey: "provisioningProfileFilename")
                additionalProperties.removeValue(forKey: "provisioningProfileUploadId")
                additionalProperties.removeValue(forKey: "scheme")
                additionalProperties.removeValue(forKey: "targetToArchive")
                additionalProperties.removeValue(forKey: "teamId")
                additionalProperties.removeValue(forKey: "xcodeProjectSha")
                additionalProperties.removeValue(forKey: "xcodeVersion")
                var decodedAdditionalProperties: [String: Anonymous] = [:]
                for key in additionalProperties.keys {
                    decodedAdditionalProperties[key] = try additionalPropertiesContainer.decode(StringCodingKey(string: key))
                }
        ...
        public required init(from decoder: Decoder) throws {
            ...
            let additionalPropertiesContainer = try decoder.container(keyedBy: StringCodingKey.self)
            var additionalProperties = try additionalPropertiesContainer.toDictionary()
            additionalProperties.removeValue(forKey: "android")
            additionalProperties.removeValue(forKey: "javascript")
            additionalProperties.removeValue(forKey: "xamarin")
            additionalProperties.removeValue(forKey: "xcode")
            var decodedAdditionalProperties: [String: Anonymous] = [:]
            for key in additionalProperties.keys {
                decodedAdditionalProperties[key] = try additionalPropertiesContainer.decode(StringCodingKey(string: key))
            }
    ...
    public init(artifactVersioning: ArtifactVersioning? = nil, badgeIsEnabled: Bool? = nil, cloneFromBranch: String? = nil, signed: Bool? = nil, testsEnabled: Bool? = nil, toolsets: Toolsets? = nil, trigger: Trigger? = nil) {
    ...
    private enum CodingKeys: String, CodingKey {
        case artifactVersioning
        case badgeIsEnabled
        case cloneFromBranch
        case signed
        case testsEnabled
        case toolsets
        case trigger
    ...
    public required init(from decoder: Decoder) throws {
        ...
        artifactVersioning = try container.decodeIfPresent(.artifactVersioning)
        badgeIsEnabled = try container.decodeIfPresent(.badgeIsEnabled)
        cloneFromBranch = try container.decodeIfPresent(.cloneFromBranch)
        signed = try container.decodeIfPresent(.signed)
        testsEnabled = try container.decodeIfPresent(.testsEnabled)
        toolsets = try container.decodeIfPresent(.toolsets)
        trigger = try container.decodeIfPresent(.trigger)

        let additionalPropertiesContainer = try decoder.container(keyedBy: StringCodingKey.self)
        var additionalProperties = try additionalPropertiesContainer.toDictionary()
        additionalProperties.removeValue(forKey: "artifactVersioning")
        additionalProperties.removeValue(forKey: "badgeIsEnabled")
        additionalProperties.removeValue(forKey: "cloneFromBranch")
        additionalProperties.removeValue(forKey: "signed")
        additionalProperties.removeValue(forKey: "testsEnabled")
        additionalProperties.removeValue(forKey: "toolsets")
        additionalProperties.removeValue(forKey: "trigger")
        var decodedAdditionalProperties: [String: Anonymous] = [:]
        for key in additionalProperties.keys {
            decodedAdditionalProperties[key] = try additionalPropertiesContainer.decode(StringCodingKey(string: key))
        }
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? BranchConfiguration else { return false }
      guard self.artifactVersioning == object.artifactVersioning else { return false }
      guard self.badgeIsEnabled == object.badgeIsEnabled else { return false }
      guard self.cloneFromBranch == object.cloneFromBranch else { return false }
      guard self.signed == object.signed else { return false }
      guard self.testsEnabled == object.testsEnabled else { return false }
      guard self.toolsets == object.toolsets else { return false }
      guard self.trigger == object.trigger else { return false }
      guard NSDictionary(dictionary: self.additionalProperties).isEqual(to: object.additionalProperties) else { return false }
      return true
    }

    public static func == (lhs: BranchConfiguration, rhs: BranchConfiguration) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
