...
public class AggregatedBillingInformation: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? AggregatedBillingInformation else { return false }
    ...
    public static func == (lhs: AggregatedBillingInformation, rhs: AggregatedBillingInformation) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
