...
public class DateTimePercentages: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? DateTimePercentages else { return false }
      guard self.datetime == object.datetime else { return false }
      guard self.percentage == object.percentage else { return false }
      return true
    }

    public static func == (lhs: DateTimePercentages, rhs: DateTimePercentages) -> Bool {
