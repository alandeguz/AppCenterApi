...
public class DistributionGroupPrivateResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? DistributionGroupPrivateResponse else { return false }
    ...
    public static func == (lhs: DistributionGroupPrivateResponse, rhs: DistributionGroupPrivateResponse) -> Bool {
