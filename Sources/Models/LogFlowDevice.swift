...
public class LogFlowDevice: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? LogFlowDevice else { return false }
    ...
    public static func == (lhs: LogFlowDevice, rhs: LogFlowDevice) -> Bool {
