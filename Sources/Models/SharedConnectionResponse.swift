...
public class SharedConnectionResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SharedConnectionResponse else { return false }
    ...
    public static func == (lhs: SharedConnectionResponse, rhs: SharedConnectionResponse) -> Bool {
