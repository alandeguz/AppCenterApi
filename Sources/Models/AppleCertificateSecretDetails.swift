...
public class AppleCertificateSecretDetails: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? AppleCertificateSecretDetails else { return false }
    ...
    public static func == (lhs: AppleCertificateSecretDetails, rhs: AppleCertificateSecretDetails) -> Bool {
