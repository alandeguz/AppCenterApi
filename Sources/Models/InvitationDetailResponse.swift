...
public class InvitationDetailResponse: APIModel {
    ...
    public init(invitedBy: InvitedBy, invitationId: ID, app: UNKNOWN_ALL_OFF? = nil, organization: Organization? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? InvitationDetailResponse else { return false }
    ...
    public static func == (lhs: InvitationDetailResponse, rhs: InvitationDetailResponse) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
