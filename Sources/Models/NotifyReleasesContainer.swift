...
public class NotifyReleasesContainer: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? NotifyReleasesContainer else { return false }
      guard self.releases == object.releases else { return false }
      return true
    }

    public static func == (lhs: NotifyReleasesContainer, rhs: NotifyReleasesContainer) -> Bool {
