...
public class BillingInformationPlans: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? BillingInformationPlans else { return false }
      guard self.buildService == object.buildService else { return false }
      guard self.testService == object.testService else { return false }
      return true
    }

    public static func == (lhs: BillingInformationPlans, rhs: BillingInformationPlans) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
