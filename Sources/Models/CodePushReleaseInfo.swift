...
public class CodePushReleaseInfo: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CodePushReleaseInfo else { return false }
    ...
    public static func == (lhs: CodePushReleaseInfo, rhs: CodePushReleaseInfo) -> Bool {
