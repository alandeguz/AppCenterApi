...
public class CodePushRelease: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CodePushRelease else { return false }
    ...
    public static func == (lhs: CodePushRelease, rhs: CodePushRelease) -> Bool {
