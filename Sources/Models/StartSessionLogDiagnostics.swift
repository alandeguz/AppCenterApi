...
public class StartSessionLogDiagnostics: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? StartSessionLogDiagnostics else { return false }
      guard self.sessionId == object.sessionId else { return false }
      return true
    }

    public static func == (lhs: StartSessionLogDiagnostics, rhs: StartSessionLogDiagnostics) -> Bool {
