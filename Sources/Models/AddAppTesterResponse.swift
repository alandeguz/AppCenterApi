...
public class AddAppTesterResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? AddAppTesterResponse else { return false }
      guard self.userId == object.userId else { return false }
      guard self.releaseId == object.releaseId else { return false }
      return true
    }

    public static func == (lhs: AddAppTesterResponse, rhs: AddAppTesterResponse) -> Bool {
