...
public class IntuneSecretDetails: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? IntuneSecretDetails else { return false }
    ...
    public static func == (lhs: IntuneSecretDetails, rhs: IntuneSecretDetails) -> Bool {
