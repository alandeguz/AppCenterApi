...
public class LogFlowStartSessionLog: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? LogFlowStartSessionLog else { return false }
      guard self.sessionId == object.sessionId else { return false }
      return true
    }

    public static func == (lhs: LogFlowStartSessionLog, rhs: LogFlowStartSessionLog) -> Bool {
