...
public class AppleConnectionNonSecretResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? AppleConnectionNonSecretResponse else { return false }
    ...
    public static func == (lhs: AppleConnectionNonSecretResponse, rhs: AppleConnectionNonSecretResponse) -> Bool {
