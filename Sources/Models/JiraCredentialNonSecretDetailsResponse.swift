...
public class JiraCredentialNonSecretDetailsResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? JiraCredentialNonSecretDetailsResponse else { return false }
      guard self.data == object.data else { return false }
      return true
    }

    public static func == (lhs: JiraCredentialNonSecretDetailsResponse, rhs: JiraCredentialNonSecretDetailsResponse) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
