...
public class PrivateSharedConnectionResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PrivateSharedConnectionResponse else { return false }
    ...
    public static func == (lhs: PrivateSharedConnectionResponse, rhs: PrivateSharedConnectionResponse) -> Bool {
