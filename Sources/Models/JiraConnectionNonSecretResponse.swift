...
public class JiraConnectionNonSecretResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? JiraConnectionNonSecretResponse else { return false }
    ...
    public static func == (lhs: JiraConnectionNonSecretResponse, rhs: JiraConnectionNonSecretResponse) -> Bool {
