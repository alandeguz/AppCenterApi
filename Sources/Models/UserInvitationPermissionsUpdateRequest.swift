...
public class UserInvitationPermissionsUpdateRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? UserInvitationPermissionsUpdateRequest else { return false }
      guard self.permissions == object.permissions else { return false }
      return true
    }

    public static func == (lhs: UserInvitationPermissionsUpdateRequest, rhs: UserInvitationPermissionsUpdateRequest) -> Bool {
