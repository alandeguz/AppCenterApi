...
public class BillingPlansSelection: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? BillingPlansSelection else { return false }
      guard self.buildService == object.buildService else { return false }
      guard self.testService == object.testService else { return false }
      return true
    }

    public static func == (lhs: BillingPlansSelection, rhs: BillingPlansSelection) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
