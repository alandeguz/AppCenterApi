...
public class GeneralDistributionGroupDetailsResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? GeneralDistributionGroupDetailsResponse else { return false }
    ...
    public static func == (lhs: GeneralDistributionGroupDetailsResponse, rhs: GeneralDistributionGroupDetailsResponse) -> Bool {
