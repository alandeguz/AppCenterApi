...
public class ServiceBillingPlans: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ServiceBillingPlans else { return false }
    ...
    public static func == (lhs: ServiceBillingPlans, rhs: ServiceBillingPlans) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
