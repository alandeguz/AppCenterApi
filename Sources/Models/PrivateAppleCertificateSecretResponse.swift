...
public class PrivateAppleCertificateSecretResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PrivateAppleCertificateSecretResponse else { return false }
      guard self.data == object.data else { return false }
      return true
    }

    public static func == (lhs: PrivateAppleCertificateSecretResponse, rhs: PrivateAppleCertificateSecretResponse) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
