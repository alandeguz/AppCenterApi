...
public class OrganizationResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? OrganizationResponse else { return false }
    ...
    public static func == (lhs: OrganizationResponse, rhs: OrganizationResponse) -> Bool {
