...
/** Event log. */
public class LogFlowEventLog: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? LogFlowEventLog else { return false }
    ...
    public static func == (lhs: LogFlowEventLog, rhs: LogFlowEventLog) -> Bool {
