...
public class LogFlowLogContainer: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? LogFlowLogContainer else { return false }
    ...
    public static func == (lhs: LogFlowLogContainer, rhs: LogFlowLogContainer) -> Bool {
