...
public class ApiTokenResponsev2: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? ApiTokenResponsev2 else { return false }
    ...
    public static func == (lhs: ApiTokenResponsev2, rhs: ApiTokenResponsev2) -> Bool {
