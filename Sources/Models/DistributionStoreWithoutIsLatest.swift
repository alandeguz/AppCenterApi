...
public class DistributionStoreWithoutIsLatest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? DistributionStoreWithoutIsLatest else { return false }
    ...
    public static func == (lhs: DistributionStoreWithoutIsLatest, rhs: DistributionStoreWithoutIsLatest) -> Bool {
