...
public class LogDiagnostics: APIModel {
 ...
 */
    ...
    public init(type: `Type`, timestamp: DateTime, installId: ID, device: Device) {
        self.type = type
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? LogDiagnostics else { return false }
    ...
    public static func == (lhs: LogDiagnostics, rhs: LogDiagnostics) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
