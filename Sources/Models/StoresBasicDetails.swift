...
public class StoresBasicDetails: APIModel {
    ...
    public init(id: String? = nil, name: String? = nil, publishingStatus: String? = nil, type: `Type`? = nil) {
        self.id = id
        self.name = name
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? StoresBasicDetails else { return false }
    ...
    public static func == (lhs: StoresBasicDetails, rhs: StoresBasicDetails) -> Bool {
