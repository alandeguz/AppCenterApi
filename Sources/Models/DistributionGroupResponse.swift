...
public class DistributionGroupResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? DistributionGroupResponse else { return false }
    ...
    public static func == (lhs: DistributionGroupResponse, rhs: DistributionGroupResponse) -> Bool {
