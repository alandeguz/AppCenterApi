...
public class CodePushReleasePromote: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? CodePushReleasePromote else { return false }
    ...
    public static func == (lhs: CodePushReleasePromote, rhs: CodePushReleasePromote) -> Bool {
