...
/** Generic log. */
public class GenericLogDiagnostics: APIModel {
 ...
 */
    ...
    public init(type: `Type`, timestamp: DateTime, installId: ID, device: Device, eventId: String? = nil, eventName: String? = nil, messageId: String? = nil, properties: [String: String]? = nil, sessionId: ID? = nil) {
        self.type = type
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? GenericLogDiagnostics else { return false }
    ...
    public static func == (lhs: GenericLogDiagnostics, rhs: GenericLogDiagnostics) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
