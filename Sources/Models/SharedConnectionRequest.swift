...
public class SharedConnectionRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? SharedConnectionRequest else { return false }
    ...
    public static func == (lhs: SharedConnectionRequest, rhs: SharedConnectionRequest) -> Bool {
