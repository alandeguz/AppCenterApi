...
/** Alerting event */
public class AlertingEvent: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? AlertingEvent else { return false }
    ...
    public static func == (lhs: AlertingEvent, rhs: AlertingEvent) -> Bool {
